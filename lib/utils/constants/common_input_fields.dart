...
class TextInputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      focusNode: focusNode,
      style: textStyle ?? AppTextStyles.grey14.copyWith(color: colorsecondary),
      ...
      cursorColor: cursorColor ?? colorsecondary,
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: contentPadding ??
              EdgeInsets.only(
                left: 12,
                bottom: kIsWeb ? 13 : Platform.isIOS ? 20 : 13,
              ),
          hintText: hintText ?? '',
          hintStyle: hintStyle ??
              TextStyle(
