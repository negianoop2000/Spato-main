...
class DeliveryNotesView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final DeliveryNotesController controller = Get.find<DeliveryNotesController>();
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child: Text(
                              order['Lieferschein_Nr'] ?? '',
                              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: colorsecondary),
                            ),
                          ), Expanded(
                            flex: 1,
                            child: order['deliveryStatus'] == 'Open'
