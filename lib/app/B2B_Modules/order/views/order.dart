...
import 'package:spato_mobile_app/app/B2B_Modules/order/veiw_alert.dart';
...
class orderB2BView extends StatelessWidget {
  @override
                          ...
                          Expanded(
                            ...
                            child: order['status'] == 'Open'
                              ...
                              child: TextButton(
                                ...
                                child: Text('Request a change',textAlign: TextAlign.center,style: TextStyle(color: textColor),),
                              ),
                            )
                                : Container(),
                          ),
