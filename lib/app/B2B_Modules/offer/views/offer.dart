...
class offerB2BView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final offerB2BController controller = Get.find<offerB2BController>();
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: order['status'] == 'Open'
                                  ? InkWell( onTap: (){
                                controller.statusChange(order['Angebots_Nr'] ?? '', order['status'] ?? '');
                              },
                                    ...
                                    child: Text('Confirm',style: AppTextStyles.black12.copyWith(color: textColor),),
                                                                    )),
                                                                  ),
                                  )
                                  : Container(),
                            ...
                            Expanded(
                              ...
                              child: order['status'] == 'Open'
                                  ? InkWell( onTap: (){
                              //  controller.launchInBrowser(Uri.parse('http://spa2.de/orders/invoice/${order['Angebots_Nr'] ?? ''}'));
                              controller.launchInBrowser(Uri.parse('http://spa2.de/OffersPdfdownload/${order['Angebots_Nr'] ?? ''}'));
                              },
                                    ...
                                    borderRadius: BorderRadius.circular(8),
                                                                    ...
                                                                    child:  Center(child: Padding(
                                    padding: const EdgeInsets.all(4.0),
                                    child: Text('Download PDF',style: AppTextStyles.black12.copyWith(color: textColor),textAlign: TextAlign.center,),
                                                                    ))
                                                                  ),
                                  )
                                  : Container(),
