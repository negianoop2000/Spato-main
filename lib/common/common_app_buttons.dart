      ...
      child: Container(
        ...
        decoration: decoration ??
            BoxDecoration(
              ...
              color: color ?? (TColors.colorprimaryLight),
...
class CommonAppButtonWithLinearGrdiant extends StatelessWidget {
  final String buttonText;
  final VoidCallback? onPressed;
  final TextStyle? btnTextStyle;
  final double? height;
  ...
  CommonAppButtonWithLinearGrdiant({
    required this.buttonText,
    required this.onPressed,
    this.btnTextStyle,
    this.height,
        ...
        decoration: decoration ??
            BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [Color(0xFFFF3D3D), Color(0xFFED3434)],
          ...
          child: Row(
            ...
            children: [
              ...
              if (!isLoading)
                Text(
                  buttonText,
                  style: btnTextStyle ?? AppTextStyles.white16,
                ),
              if (!isLoading && btnIcon != null)
                Icon(btnIcon, color: btnIconColor ?? Colors.transparent),
            ],
